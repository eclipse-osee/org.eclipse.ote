 ...
 */
public class TEST_MUX_MSG_T extends MuxMessage {
   ...
   public TEST_MUX_MSG_T() {
      super("TEST_MUX_MSG_1", BYTE_SIZE, BYTE_OFFSET, IS_SCHED, PHASE, RATE);
      MuxData messageData = new MuxData(this, this.getClass().getName(), getName(), getDefaultByteSize(), CHANNEL, TERMINAL, MuxReceiveTransmit.TRANSMIT, SUBADDRESS, GenericOteIoType.MUX);
