...
/**
 * An extension of the class {@link CommandLineParameterDefinition} for defining a command line parameter for a
 * directory path.
 * 
 * @author Loren K. Ashley
 */

public class CommandLineParameterDirectory extends CommandLineParameterDefinition {

   /**
    * Creates a new {@link CommandLineParameterDefinition} for a directory path command line parameter.
    * <p>
    ...
    * <li>When {@link mustExist} is {@code true} and the directory specified for the command line parameter does not
    * exist.</li>
    * </ul>
    * The {@code biConsuer} will be called with the directory path when all error checks pass.
    * 
    ...
    * @param mustExist when {@code true} the specified directory must exist.
   ...
   //@formatter:off
   public CommandLineParameterDirectory
      (
         ...
         (
           ...
           ( application, commandLineParameterToken, message ) ->
           {
              ...
              if( linkedCommandLineParameterTokenOptional.isPresent() )
              {
                 ...
                 if( mustExist && !directoryPath.toFile().isDirectory() )
                 {
                     message
                        .append( "ERROR: Path to directory is invalid." ).append( "\n" )
                        .append( "   Directory Path: " ).append( directoryPath                         ).append( "\n" )
