...
public class OteProperties extends OseeProperties {
   ...
   private static final String OSEE_ABORT_ON_FAIL = "ote.abort.on.fail";
   ...
   /**
    * @return true if Abort On Fail option is set to true
    */
   public static boolean isAbortOnFailEnabled() {
      return "true".equals(System.getProperty(OSEE_ABORT_ON_FAIL));
   }
}
