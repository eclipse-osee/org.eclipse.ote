			...
			<body>
				...
				<TABLE width="95%">					
					...
					<TR>
						...
						<xsl:if test="string($modifiedFlag) and not($modifiedFlag = '-')"> - <xsl:value-of select="Config/ScriptVersion/@modifiedFlag" /></xsl:if>
						</TD>
					</TR>	
					<TR>
	...
	<xsl:template match="TestCase/Trace|Trace/Trace|ScriptInit/Trace">
		<TR bgColor="#ffffff">
			<TD colspan="2">
				<TABLE width="100%" style="border-left: 1px solid #999999;">
					<TR>
						<TD align="left" style="FONT-SIZE: 13px; width: 5%;">
							<b>Trace:</b>
						</TD>
						<TD align="left" style="FONT-SIZE: 13px; FONT-WEIGHT: bold; width: 95%;">
