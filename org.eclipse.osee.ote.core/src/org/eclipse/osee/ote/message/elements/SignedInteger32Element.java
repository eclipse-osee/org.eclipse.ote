 ...
 */
public class SignedInteger32Element extends SignedIntegerElement {

   public SignedInteger32Element(Message message, String elementName, MessageData messageData, int byteOffset, int msb) {
