...
import org.eclipse.osee.ote.message.elements.nonmapping.NonMappingUnsignedIntegerElement;
 ...
 */
public class UnsignedIntegerElement extends NumericElement<Integer> {
   ...
   public UnsignedIntegerElement(Message message, String elementName, MessageData messageData, int byteOffset, int msb, int lsb) {
      this(message, elementName, messageData, byteOffset, msb, lsb, msb, lsb);
   }

   public UnsignedIntegerElement(Message message, String elementName, MessageData messageData, int bitOffset, int bitLength) {
      super(message, elementName, messageData, bitOffset, bitLength);
   }

   public UnsignedIntegerElement(Message message, String elementName, MessageData messageData, int byteOffset, int msb, int lsb, int originalLsb, int originalMsb) {
      super(message, elementName, messageData, byteOffset, msb, lsb, originalLsb, originalMsb);
   }

   @Override
   public UnsignedIntegerElement findElementInMessages(Collection<? extends Message> messages) {
      return (UnsignedIntegerElement) super.findElementInMessages(messages);
   }
   
   @Override
   public UnsignedIntegerElement switchMessages(Collection<? extends Message> messages) {
      return (UnsignedIntegerElement) super.switchMessages(messages);
   }
   ...
   protected Element getNonMappingElement() {
      return new NonMappingUnsignedIntegerElement(this);
   }
   ...
   public static void main(String[] args) {
      ...
      UnsignedIntegerElement e1 = new UnsignedIntegerElement(null, "e1", hd, 0, 0, 31);
      UnsignedIntegerElement e2 = new UnsignedIntegerElement(null, "e2", hd, 4, 0, 31);
      e1.setValue(-1);
      e2.setValue(-1000);
