 ...
 */
public class SignedLongIntegerElement extends NumericElement<Long> {

   public SignedLongIntegerElement(Message message, String elementName, MessageData messageData,
   ...
   @Override
   public SignedLongIntegerElement findElementInMessages(Collection<? extends Message> messages) {
      return (SignedLongIntegerElement) super.findElementInMessages(messages);
   }

   @Override
   public SignedLongIntegerElement switchMessages(Collection<? extends Message> messages) {
      return (SignedLongIntegerElement) super.switchMessages(messages);
   }
    ...
    */
   public void checkForwarding(ITestAccessor accessor, SignedLongIntegerElement cause,
