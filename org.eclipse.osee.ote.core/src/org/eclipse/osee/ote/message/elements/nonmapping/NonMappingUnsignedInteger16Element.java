...
public class NonMappingUnsignedInteger16Element extends UnsignedInteger16Element {

   /**
    * Copy constructor.
    * @param element 
    */
   public NonMappingUnsignedInteger16Element(UnsignedInteger16Element element) {
   ...
   public NonMappingUnsignedInteger16Element(Message message, String elementName, MessageData messageData, int byteOffset, int msb, int lsb) {
   ...
   public int waitForValue(ITestEnvironmentAccessor accessor, short value, int milliseconds) throws InterruptedException {
      throwNoMappingElementException();
      return 0;
   }

   public int waitForNotValue(ITestEnvironmentAccessor accessor, short value, int milliseconds) throws InterruptedException {
      throwNoMappingElementException();
      return 0;
   }
