...
/**
 * Represent any message field as an unsigned integer from 1 to 7 bits in length
 * 
...
public class MsgElementUnsignedInteger8 extends MsgElementNumeric<Byte> {
    ...
    * @param requestor 
    */
   public MsgElementUnsignedInteger8(Class<? extends Message> sourceMessageClass, UnsignedInteger8Element sourceElement, IMessageRequestor<Message> requestor) {
