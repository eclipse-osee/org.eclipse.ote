...
public class TestRunTransactionEndpointPublisher {
   ...
   private final String branchName = OtePropertiesCore.oseeConfigBranchId.getValue(DEFAULT_BRANCH_NAME); //This should be connected to user supplied branch in future
